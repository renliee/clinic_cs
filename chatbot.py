...
def _try_resolve_ambiguous_time(message: str, ambig: dict) -> dict[str, str] | None: 
    msg = message.strip() 
...
Sudah benar ya kak? ketik atau pilih 'ya' untuk konfirmasi atau 'ganti X' untuk ubah informasi booking."""
